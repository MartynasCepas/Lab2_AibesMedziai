...
public class Timekeeper {
     ...
     * @param semaphore
     */
    public Timekeeper(int[] kiekiai,int am, BlockingQueue<String> resultsLogger, Semaphore semaphore) {
        this.tyrimoImtis = kiekiai;
        this.medzioAukstis=am;
